...
Afterwards, we compared the resulting frame predictions with the actual predictions and calculated accuracy, precision, and recall on a frame basis. % is that correct?. Yes, it is.
