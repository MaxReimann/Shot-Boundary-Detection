...
We make fewer mistakes on the noise in Figure~\ref{fig:hard_cut_visualization}, but high peaks like in Figure~\ref{fig:hard_cut_noise_visualization} are still problematic.
